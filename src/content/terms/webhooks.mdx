---
title: "Webhooks"
description: "User-defined HTTP callbacks der bliver udløst af specifikke hændelser, og gør det muligt for en applikation at modtage real-time data."
...
- **Traditional API**: You're a customer at a restaurant who keeps asking the waiter "Is my food ready yet?" every few minutes. This is inefficient—you're interrupting the waiter constantly, and most checks result in "not yet."
